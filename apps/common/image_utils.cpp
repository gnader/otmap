...
void generate_blue_noise_tile(int n, std::vector<Eigen::Vector2d> &pts, const std::vector<Eigen::Vector2d> &tile)
{
    int nb = tile.size();
    int N = std::sqrt(nb);
...
void generate_blue_noise_tile(int n, std::vector<Eigen::Vector2d> &pts, const std::string &tile_filename)
{
...
bool save_point_cloud_dat(const std::string &filename, const std::vector<Eigen::Vector2d> &points)
{
    std::ofstream file;
    file.open(filename);
...
bool load_point_cloud_dat(const std::string &filename, std::vector<Eigen::Vector2d> &points)
{
    std::ifstream file;
    file.open(filename);
...
bool save_point_cloud_eps(const std::string &filename, const std::vector<Eigen::Vector2d> &points, double radius_scale)
{
