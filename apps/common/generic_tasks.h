...
void generate_transport_maps(const std::vector<std::string> &inputs, std::vector<otmap::TransportMap> &tmaps, const CLI_OTSolverOptions &opts, std::function<void(Eigen::MatrixXd &)> filter = [](Eigen::MatrixXd &) {});
